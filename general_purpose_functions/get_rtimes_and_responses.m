...
% responses = vector containing the responses of the subject
%
...
function [rtimes, chain, responses] = get_rtimes_and_responses(data, nid, from, till, tau_id)
...
responses = data(beg:stop,8);
responses = responses(from:till,1);
